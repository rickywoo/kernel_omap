...
PVRSRV_ERROR SysInitialise(IMG_VOID)
{
	...
	/* FIXME-HASH: DISABLED IDLE DEBUGGING */
	// sgx_idle_init();
	return PVRSRV_OK;
}
...
/* FIXME-HASH: Removed for old style */
...
{
	sgx_idle_log_init();
	hrtimer_init(&sgx_idle_timer, HRTIMER_BASE_MONOTONIC, HRTIMER_MODE_REL);
	hrtimer_init(&sgx_idle_timer, CLOCK_MONOTONIC, HRTIMER_MODE_REL);
